...
In a sysem where the gola is to predict a users taste in movies it may be benificial to invesitgate users and the ratings they have provided. We will start by building averages for each user. This should tell us if a user is someone who scores movies high or low in general.
